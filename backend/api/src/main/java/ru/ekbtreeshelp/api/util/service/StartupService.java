...
public class StartupService {
    ...
    private void createDefaultSpecies() {
        Set.of("Ель", "Кедр", "Лиственница", "Пихта", "Сосна", "Кипарисовик", "Можжевельник", "Туя", "Акация",
                ...
                "Невозможно определить", "Ель колючая", "Каштан", "Клён", "Клён ясенелистный (американский)",
                "Клён остролистный", "Клён татарский", "Сосна кедровая", "Тополь  бальзамический",
                "Тополь пирамидальный", "Тополь серебристый", "Черемуха Маака")
