package ru.ekbtreeshelp.api.file.controller;
...
import ru.ekbtreeshelp.api.file.mapper.FileMapper;
...
public class FileController {
    ...
    public FileDto get(@PathVariable Long id) {
        return fileMapper.toDto(fileService.get(id));
    }
